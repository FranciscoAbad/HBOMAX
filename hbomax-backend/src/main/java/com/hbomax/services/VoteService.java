...
import com.hbomax.mappers.VoteMapper;
...
public class VoteService {
    ...
    @Autowired
    public VoteService(VoteRepository voteRepo, TitleRepository titleRepo, UserRepository userRepo, VoteMapper voteMapper) {
